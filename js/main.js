...
const TRANSLATIONS = {
  fr: {
    ...
    nav_propositions: 'Propositions',
    nav_contact: 'Contact',
    nav_prop_ia: 'Agent IA',
    nav_prop_web: 'Développement Web',
    nav_prop_streaming: 'Logiciel Streaming',
    nav_cta: 'Démarrer un projet',
    hero_badge: 'Disponible pour nouveaux projets',
    hero_title_1: 'Construisons votre',
    hero_title_2: 'présence numérique',
    hero_title_3: 'de demain.',
    ...
    hero_btn_primary: 'Voir mes services',
    hero_btn_secondary: 'Me contacter',
    stat_1: 'Projets livrés',
    stat_2: 'Ans d\'expérience',
    stat_3: 'Clients satisfaits',
    stat_4: 'Technologies',
    services_tag: 'Expertise',
    services_title: 'Des solutions numériques complètes',
    ...
    about_tag: 'À propos',
    about_title: 'Technologie & passion au service de vos projets',
    about_desc: 'Je suis Oumate Razakou, développeur Full Stack et expert en Intelligence Artificielle basé à Lomé, Togo. Depuis plusieurs années, je conçois des solutions numériques innovantes pour les entreprises qui veulent prendre une longueur d\'avance dans leur transformation digitale.',
    ...
    portfolio_title: 'Réalisations & Projets',
    props_tag: 'Propositions',
    props_title: 'Mes offres de services détaillées',
    ...
    form_ph_phone: '+228 XX XX XX XX',
    form_ph_message: 'Décrivez votre projet, vos besoins, votre budget...',
    footer_desc: 'Développeur Full Stack & Expert IA basé à Lomé, Togo. Je crée des solutions numériques sur mesure pour les entreprises ambitieuses.',
  ...
  en: {
    ...
    nav_services: 'Services',
    nav_portfolio: 'Portfolio',
    nav_propositions: 'Proposals',
    nav_contact: 'Contact',
    nav_prop_ia: 'AI Agent',
    nav_prop_web: 'Web Development',
    nav_prop_streaming: 'Streaming Software',
    nav_cta: 'Start a project',
    hero_badge: 'Available for new projects',
    hero_title_1: 'Let\'s build your',
    hero_title_2: 'digital presence',
    hero_title_3: 'of tomorrow.',
    ...
    hero_btn_primary: 'See my services',
    ...
    portfolio_tag: 'Portfolio',
    portfolio_title: 'Work & Projects',
    props_tag: 'Proposals',
    props_title: 'My detailed service proposals',
...
function initParticles(canvasId) {
  ...
  class Particle {
    ...
    reset() {
      ...
      this.color = Math.random() > 0.5 ? '26,86,219' : '6,182,212';
    }
    update() {
...
function initTyped() {
  ...
  function type() {
    ...
    if (!deleting) {
      ...
      ci++;
      if (ci === current.length) { paused = true; deleting = true; }
      setTimeout(type, 90);
    } else {
      el.textContent = current.slice(0, ci-1);
      ci--;
...
function initContactForm() {
  ...
  form.addEventListener('submit', e => {
    ...
    if (!name || !email || !message) {
      btn.textContent = currentLang === 'fr' ? '⚠️ Remplissez les champs requis' : '⚠️ Fill required fields';
    ...
    // Labels de service traduits
    const serviceLabels = {
      web:       currentLang === 'fr' ? 'Développement Web' : 'Web Development',
      ia:        currentLang === 'fr' ? 'Agent IA'          : 'AI Agent',
      streaming: 'Logiciel Streaming',
      marketing: 'Marketing Digital',
      conseil:   currentLang === 'fr' ? 'Conseil Digital'   : 'Digital Consulting',
      autre:     currentLang === 'fr' ? 'Autre'             : 'Other',
    };
    ...
    const waURL = `https://wa.me/22892101969?text=${encodeURIComponent(waMessage)}`;
